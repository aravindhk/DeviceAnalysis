...
for i in device_index:
    ...
    for j in channel_index:        
        ...
        if my_file_g.exists() and my_file_d.exists():  # Checking if IdVg and IdVd files exist            
            ...
            input_data[inp_count] = InputData(idvg_data, idvd_data, channel_length, channel_L, j)  # Assigning the read data to InputData object
            inp_count += 1

    params = Parameters(col_index, num_var_idvg, num_vd_idvg, num_var_idvd, num_vg_idvd, W, Cox, isbipolar_idvd)
